...
TASK_UNBINDGLUHUT = 'UnbindGluhut'#temp
TASK_BINDGLUHUT = "BindGluhut" #temp
...
KEY_GLUHUTENERGY = 'gluhut-energy' #temp
...
TRUE = 'True'
FALSE = 'False'
BINDEDFINISHED = 'binded-finished'
UNBINDFINISHED = 'unbind-finished'  
...
GLUHUT_BINDING = 'gluhut-binding'
GLUHUT_UNBINDING = 'gluhut-unbinding'
# ---------------- #
# PLAYER
# ---------------- #
...
PLAYER_UNBINDGLUHUT = 'UnbindGluhut' #temp
PlAYER_BINDGLUHUT = 'BindGluhut' #temp
KEY_BIND_STATUS = 'Player.BindStatus' #temp
# ---------------- #
# SHARED STATE
# ---------------- #
...
KEYS_WITH_UNRESTRICTED_VALS = [KEY_TASK_COMPLETION_TIME, KEY_SIMULATION_NAME, KEY_SIMULATION_SERVER_INDEX,
                               ...
                               KEY_SIM_COUNTER, KEY_START_TIME, KEY_END_TIME, KEY_TASK_COMMENT,KEY_GLUHUTENERGY]
